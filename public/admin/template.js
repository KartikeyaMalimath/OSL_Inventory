...
<div class="sidebar" data-color="rose" data-background-color="black" data-image="../../assets/img/sidebar-1.jpg">
    <div class="logo">
        <a href="https://osl.vvce.ac.in" class="simple-text logo-mini">
        OSL
        </a>
        <a href="https://osl.vvce.ac.in" class="simple-text logo-normal">
        Open Source Lab
        </a>
    </div>
    <div class="sidebar-wrapper">
        ...
        <li class="nav-item ">
            <a id="forms" class="nav-link" data-toggle="collapse" href="#formsExamples">
            ...
            <ul class="nav">
                ...
                <a class="nav-link" href="./register.html">
                    ...
                    <span class="sidebar-normal"> Registration Forms </span>
                </a>
                </li>
                <li id="mem" class="nav-item ">
                <a class="nav-link" href="./membership.html">
                    <span class="sidebar-mini"> MF </span>
                    <span class="sidebar-normal"> Membership Forms </span>
                </a>
                </li>
            </ul>
            </div>
        ...
        <li class="nav-item ">
            <a id="components" class="nav-link" data-toggle="collapse" href="#componentsExamples">
            ...
            <ul class="nav">
                <li id="addc" class="nav-item ">
                <a class="nav-link" href="./addcomponents.html">
                    <span class="sidebar-mini"> AC </span>
                    <span class="sidebar-normal"> Add Components </span>
                </a>
                </li>
                <li id="mem" class="nav-item ">
